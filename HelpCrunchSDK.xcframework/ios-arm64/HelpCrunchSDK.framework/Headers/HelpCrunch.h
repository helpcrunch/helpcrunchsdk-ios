...
static NSString * _Nonnull const HCSSDKVersion = @"4.2.3";
...
/**
 Standard UserNotification permissions request.
 */
+ (void)registerForRemoteNotifications;

/**
 Use this method on app launch if you plan to use your own UNUserNotificationCenterDelegate
 */
+ (void)disablePushNotificationDelegate;
